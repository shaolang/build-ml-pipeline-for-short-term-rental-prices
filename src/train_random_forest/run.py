...
def go(args):
    ...
    run = cast(Run, wandb.init(job_type="train_random_forest"))
    ...
    mlflow.sklearn.save_model(sk_pipe, 'random_forest_dir', signature=signature, input_example=X_val[:2])

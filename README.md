...
Project for Udacity Course: [Building a Reproducible Model Workflow][udacity-course].
This project's repo is at [shaolang/build-ml-pipeline-for-short-term-rental-prices][repo].
The companion workflow tracking is at [Weights & Biases][wandb-project].

[udacity-course]: https://www.udacity.com/course/building-a-reproducible-model-workflow--cd0581
[wandb-project]: https://wandb.ai/aishaolang/nyc_airbnb?nw=nwuseraishaolang
[repo]: https://github.com/shaolang/build-ml-pipeline-for-short-term-rental-prices
